...
router.post('/writeBoard', function _callee9(req, res, next) {
...
router.post('/loadBoard', function _callee10(req, res, next) {
...
router.post('/userProfile', function _callee11(req, res, next) {
  var db, email, user;
    ...
    while (1) {
      switch (_context11.prev = _context11.next) {
        ...
        case 20:
          ...
          next(_context11.t0); // 에러 핸들링 미들웨어로 전달
...
router.post('/updateProfile', function _callee12(req, res, next) {
...
router.post('/signUp', function _callee13(req, res, next) {
...
router.post('/login', function _callee14(req, res, next) {
